package com.prakashspicesfsm.features.logoutsync.presentation
...
import com.prakashspicesfsm.CustomConstants
...
import com.prakashspicesfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.prakashspicesfsm.features.billing.api.AddBillingRepoProvider
import com.prakashspicesfsm.features.billing.model.AddBillingInputParamsModel
...
import com.prakashspicesfsm.features.dashboard.presentation.ReasonDialog
...
import com.prakashspicesfsm.features.document.model.AddEditDocumentInputParams
import com.prakashspicesfsm.features.document.model.DocumentAttachmentModel
...
import com.prakashspicesfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.prakashspicesfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.prakashspicesfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.prakashspicesfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.prakashspicesfsm.features.orderhistory.model.*
...
import com.prakashspicesfsm.features.quotation.model.AddQuotInputModel
import com.prakashspicesfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.prakashspicesfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.prakashspicesfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.prakashspicesfsm.features.stock.api.StockRepositoryProvider
import com.prakashspicesfsm.features.stock.model.AddStockInputParamsModel
import com.prakashspicesfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.prakashspicesfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.prakashspicesfsm.features.timesheet.model.AddTimeSheetInputModel
...
import com.prakashspicesfsm.MonitorService
import com.prakashspicesfsm.MySingleton
...
import com.prakashspicesfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.prakashspicesfsm.features.login.model.GetConcurrentUserResponse
import com.prakashspicesfsm.features.login.model.WhatsappApiData
import com.prakashspicesfsm.features.performance.model.Gps_status_list
import com.prakashspicesfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.prakashspicesfsm.features.returnsOrder.ReturnProductList
import com.prakashspicesfsm.features.returnsOrder.ReturnRequest
import com.prakashspicesfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprakashspicesfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprakashspicesfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xprakashspicesfsmlogsample/log.zip").path);
